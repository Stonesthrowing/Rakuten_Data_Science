...
# -------------------------------------------------------------------
LOCAL_CANDIDATES = [
    Path(r"C:\Streamlit\I12_ConvNeXT"),
    Path(r"C:\Streamlit"),
]
...
AUGMENTATION_GROUPS = [
    ...
    {
        "Group": "Moderate augmentation — ConvNeXt Base exact implementation",
        "Models": "I12",
        ...
        "Comment": "Exact transform from the available I12 ConvNeXT-Base training script."
    },
    {
        "Group": "Moderate augmentation — all other models",
        "Models": "I2, I6, I7, I8, I9, I11",
        ...
        "Comment": "Grouped together to avoid falsely claiming that every moderate run used the exact I12 ConvNeXt transform."
    },
    {
...
if page not in [
    ...
    st.info(
        "Do both ConvNeXT models use the same augmentation? The I12 ConvNeXT-Base transform is known exactly. "
        "I9 ConvNeXt-Tiny is reported as a moderate-augmentation ConvNeXt run, but the exact I9 transform is not available in the current app artifact set, so it is not marked as identical to I12."
    )
